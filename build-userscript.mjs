...
// Thin client: only proxy placeholders are substituted — no content is baked in
// (the script fetches faq/library/AI from the Worker at runtime).
...
for (const ph of ["__PROXY_BASE__", "__PROXY_HOST__"]) {
